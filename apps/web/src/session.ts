...
export function useSession(): Session {
  ...
  */
  ...
  /*
    Each recording's own frame table, read once and asked two questions: how much the
    picture moves, and whether a proxy could be made the fast way. Not cached — it costs
