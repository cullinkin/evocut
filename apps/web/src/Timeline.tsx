...
export interface TimelineProps {
   ...
   *
   * Drawn over the sound in the same lane rather than in one of its own: a hit you can hear
   * and a movement you can see are the same event, and putting them one above the other
   * makes you check twice.
   */
...
export function TimelineEditor({
  ...
  */
  ...
  const waveMotion = useMemo(() => {
    ...
    for (const [sourceId, measured] of pictures) {
      ...
      if (measured.allIntra) continue;
      out.set(sourceId, {
        hopUs: measured.hopUs,
        weight: measured.weight,
        peakBytes: measured.peakBytes,
        medianBytes: measured.medianBytes,
      });
    }
    return out;
  }, [pictures]);
